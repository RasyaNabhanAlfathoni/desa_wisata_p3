        ...
        <div class="row justify-content-center">
            <div class="col-12">
                ...
                <div class="card shadow">
                    <div class="card-body">
                        <form action="{{ route('kelola_data_pelanggan.store') }}" method="POST" id="frmPelanggan" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <div id="passwordHelp" class="form-text text-warning">
                                    Note: Pastikan memiliki kata sandi yang kuat dan mudah diingat.
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="foto">Foto Pelanggan</label>
                                <input type="file" class="form-control" name="foto" id="foto" accept="image/*" required>
                                <div id="foto" class="form-text text-warning">Unggah Foto Profile Anda! (Maks 3MB)</div>
                            </div>
