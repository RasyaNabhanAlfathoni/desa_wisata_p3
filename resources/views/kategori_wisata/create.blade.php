        ...
        <div class="row justify-content-center">
            <div class="col-12">
                ...
                <div class="card shadow">
                    <div class="card-body">
                        <form action="{{ route('kelola_kategori_wisata.store') }}" id="frmKategoriWisata" method="POST" enctype="multipart/form-data">
                            @csrf

                            <div class="form-group">
                                <label for="kategori_wisata">Nama Kategori Wisata</label>
                                <input type="text" class="form-control" name="kategori_wisata" id="kategori_wisata" required value="{{ old('kategori_wisata') }}">
                            </div>
