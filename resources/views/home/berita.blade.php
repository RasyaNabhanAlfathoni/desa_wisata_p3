          ...
          <div class="col-lg-3 sidebar ftco-animate">
              ...
              <div class="sidebar-box ftco-animate">
                  ...
                  <div class="block-21 mb-4 d-flex">
                      <a href="{{ route('berita.detail', $recent->id) }}" class="blog-img mr-4" style="background-image: url('{{ asset('storage/' . $recent->foto) }}');"></a>
                      <div class="text">
                          <h3 class="heading-1"><a href="{{ route('berita.detail', $recent->id) }}">{{ Str::limit($recent->judul, 30) }}</a></h3>
                          <div class="meta">
              ...
              <div class="sidebar-box ftco-animate">
                  ...
                  <ul class="categories">
                      @foreach($kategoriBeritas as $kategori)
                      <li><a href="{{ url('berita?kategori_id=' . $kategori->id) }}">{{ $kategori->kategori_berita }} </a><span>({{ $kategori->berita->count() }})</span></li>
                      @endforeach
                  </ul>
              </div>
          </div>
              ...
              <div class="row">
                  ...
                  <div class="col-md-12 ftco-animate">
                      <div class="blog-entry d-md-flex">
                          <a href="{{ route('berita.detail', $berita->id) }}" class="img img-2" style="background-image: url('{{ asset('storage/' . $berita->foto) }}');"></a>
                          <div class="text text-2 pl-md-4">
                              <h3 class="mb-2"><a href="{{ route('berita.detail', $berita->id) }}">{{ $berita->judul }}</a></h3>
                              <div class="meta-wrap">
                                  <p class="meta">
                              ...
                              <p><a href="{{ route('berita.detail', $berita->id) }}" class="btn-custom">Baca Selengkapnya <span class="ion-ios-arrow-forward"></span></a></p>
                          </div>
                      </div>
                  </div>
                  @endforeach
