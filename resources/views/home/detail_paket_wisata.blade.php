            ...
            <div class="col-lg-8">
                ...
                <div class="card shadow-sm border-0 mb-4">
                    <div class="card-body">
                        ...
                        <div class="mt-4">
                            @auth
                                <a href="{{ route('paket-wisata.reservasi', $paket->id) }}" class="btn btn-primary btn-lg btn-block">
                                    ...
                                    <div class="card h-100 border-0 shadow-sm">
                                        ...
                                        <div class="card-body p-3">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                ...
                                                <a href="{{ route('paket-wisata.detail', $item->id) }}" class="btn btn-sm btn-outline-primary">Pesan</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
