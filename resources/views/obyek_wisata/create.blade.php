        ...
        <div class="row justify-content-center">
            <div class="col-12">
                ...
                <div class="card shadow">
                    <div class="card-body">
                        <form action="{{ route('kelola_obyek_wisata.store') }}" id="frmWisata" method="POST" enctype="multipart/form-data">
                            @csrf

                            <div class="form-group">
                                <label for="nama_wisata">Nama Obyek Wisata</label>
                                <input type="text" class="form-control" name="nama_wisata" id="nama_wisata" required value="{{ old('nama_wisata') }}">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="deskripsi_wisata" id="deskripsi_wisata" rows="4" required>{{ old('deskripsi_wisata') }}</textarea>
                            </div>
