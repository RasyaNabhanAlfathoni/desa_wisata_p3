        ...
        <div class="row justify-content-center">
            <div class="col-12">
                ...
                <div class="card shadow">
                    <div class="card-body">
                        <form action="{{ route('kelola_kategori_berita.store') }}" id="frmKategoriBerita" method="POST" enctype="multipart/form-data">
                            @csrf

                            <div class="form-group">
                                <label for="kategori_berita">Nama Kategori berita</label>
                                <input type="text" class="form-control" name="kategori_berita" id="kategori_berita" required value="{{ old('kategori_berita') }}">
                            </div>
