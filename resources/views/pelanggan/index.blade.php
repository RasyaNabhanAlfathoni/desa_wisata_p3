                    ...
                    <div class="destination-slider owl-carousel ftco-animate">
                        ...
                        <div class="item">
                            <div class="destination">
                                ...
                                <div class="text p-3">
                                    <h3><a href="{{ route('pelanggan.obyek-wisata.detail', $obyek->id) }}">{{ $obyek->nama_wisata }}</a></h3>
                ...
                <div class="item">
                    <div class="destination">
                        ...
                        <div class="text p-3">
                            <div class="d-flex">
                                <div class="one">
                                    <h3><a href="{{ route('pelanggan.penginapan.detail', $penginapan->id) }}">{{$penginapan->nama_penginapan}}</a></h3>
                                    {{-- <p class="rate">
                                        <i class="icon-star"></i>
                                        <i class="icon-star"></i>
                                        <i class="icon-star"></i>
                            ...
                            <p class="bottom-area d-flex">
                                ...
                                <span class="ml-auto"><a href="{{ route('pelanggan.penginapan.detail', $penginapan->id) }}">Detail</a></span>
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="blog-entry h-100">
                        ...
                        <div class="text p-4">
                            ...
                            <h3 class="heading mt-3" style="cursor: pointer" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="{{$berita->judul}}">
                                <a href="{{ route('pelanggan.berita.detail', $berita->id) }}">{{substr($berita->judul, 0, 30) . '...'}}</a>
                            </h3>
                            @else
                            <h3 class="heading mt-3" style="cursor: pointer" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="{{$berita->judul}}">
                                <a href="{{ route('pelanggan.berita.detail', $berita->id) }}">{{ $berita->judul }}</a>
                            </h3>
                            @endif

                            <div class="meta mb-3 d-flex justify-content-between">
                                <div><a href="{{ route('pelanggan.berita.detail', $berita->id) }}"><i class="icon-calendar mr-1"></i> {{$berita->tgl_post}}</a></div>
                            </div>
                        </div>
                    </div>
                </div>
