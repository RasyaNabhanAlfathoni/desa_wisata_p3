...
<div class="hero-wrap js-fullheight" style="background-image: url('{{ asset('storage/' . $obyek->foto1) }}'););">
        ...
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
            <div class="col-md-9 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
                <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">
                    ...
                    <span><a href="{{ route('pelanggan.obyek_wisata') }}">Obyek Wisata</a></span>|
                    <span>{{ $title2 }}</span>
                </p>
                            ...
                            @foreach($chunk as $obyek)
                                <div class="col-md-4 p-3">
                                    <div class="card h-100 border-0 shadow-sm">
                                        <a href="{{ route('pelanggan.obyek-wisata.detail', $obyek->id) }}">
                                        ...
                                        <div class="card-body p-3">
                                            <div class="d-flex justify-content-between">
                                                <div>
                                                    <h5 class="card-title">
                                                        <a href="{{ route('pelanggan.obyek-wisata.detail', $obyek->id) }}" class="text-dark">{{ $obyek->nama_wisata }}</a>
                                                    </h5>
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                ...
                                                <a href="{{ route('pelanggan.obyek-wisata.detail', $obyek->id) }}" class="btn btn-sm btn-outline-primary">Detail</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
