      ...
      <div class="row">
          <div class="col-lg-3 sidebar ftco-animate">
              <div class="sidebar-wrap bg-light ftco-animate">
                  ...
                  <form action="{{ url('pelanggan/penginapan') }}" method="GET">
                    <div class="fields">
                      ...
                      <div class="form-group">
                        <button type="submit" class="btn btn-primary py-3 px-3 w-100">
                            <i class="fas fa-search mr-2"></i> Cari Penginapan
                        </button>
                        @if(request()->has('nama_penginapan'))
                            <a href="{{ url('pelanggan/penginapan') }}" class="btn btn-outline-secondary py-3 px-5 w-100 mt-2">
                                Reset Pencarian
                            </a>
                        @endif
                      </div>
                    ...
                    <div class="destination">
                        ...
                        <div class="text p-3">
                            ...
                            <p class="bottom-area d-flex">
                                ...
                                <span class="ml-auto">
                                    <a href="{{ route('pelanggan.penginapan.detail', $penginapan->id) }}">Detail</a>
                                </span>
                            </p>
                        </div>
                    </div>
