      ...
      <div class="row">
          <div class="col-lg-3 sidebar ftco-animate">
              <div class="sidebar-wrap bg-light ftco-animate">
                  ...
                  <form action="{{ url('pelanggan/obyek-wisata') }}" method="GET">
                    <div class="fields">
                      ...
                      <div class="form-group">
                        ...
                        @if(request()->has('kategori_id') || request()->has('nama_wisata'))
                                <a href="{{ url('pelanggan/obyek-wisata') }}" class="btn btn-outline-secondary py-3 px-5 w-100 mt-2">
                                    Reset Pencarian
                                </a>
                            @endif
                      </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4 ftco-animate">
                    <div class="destination">
                        <a href="{{ route('pelanggan.obyek-wisata.detail', $obyek->id) }}" class="img img-2 d-flex justify-content-center align-items-center"
                        ...
                        <div class="text p-3">
                            ...
                            <p class="bottom-area d-flex">
                                ...
                                <span class="ml-auto">
                                    <a href="{{ route('pelanggan.obyek-wisata.detail', $obyek->id) }}">Detail</a>
                                </span>
                            </p>
                        </div>
                    </div>
