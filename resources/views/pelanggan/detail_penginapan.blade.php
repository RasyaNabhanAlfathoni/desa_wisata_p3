        ...
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
            <div class="col-md-9 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
                <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">
                    ...
                    <span><a href="{{ route('pelanggan.penginapan') }}">Penginapan</a></span>|
                    <span>{{ $title2 }}</span>
                </p>
                            ...
                            @foreach($chunk as $penginapan)
                                <div class="col-md-4 p-3">
                                    <div class="card h-100 border-0 shadow-sm">
                                        <a href="{{ route('pelanggan.penginapan.detail', $penginapan->id) }}">
                                        ...
                                        <div class="card-body p-3">
                                            <div class="d-flex justify-content-between">
                                                <div>
                                                    <h5 class="card-title">
                                                        <a href="{{ route('pelanggan.penginapan.detail', $penginapan->id) }}" class="text-dark">{{ $penginapan->nama_penginapan }}</a>
                                                    </h5>
                                                </div>
                                            </div>
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                ...
                                                <a href="{{ route('pelanggan.penginapan.detail', $penginapan->id) }}" class="btn btn-sm btn-outline-primary">Detail</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
