        ...
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
            <div class="col-md-9 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
                <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">
                    ...
                    <span><a href="{{ route('pelanggan.berita') }}">Berita</a></span>|
                    <span>{{ $title2 }}</span>
                </p>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-4">
                                <div class="card border-0 h-100">
                                    <a href="{{ route('pelanggan.berita.detail', $related->id) }}">
                                        <img src="{{ asset('storage/' . $related->foto) }}" class="card-img-top" alt="{{ $related->judul }}" style="height: 200px; object-fit: cover;">
                                    </a>
                                    <div class="card-body">
                                        <h5 class="card-title">
                                            <a href="{{ route('pelanggan.berita.detail', $related->id) }}" class="text-dark">{{ Str::limit($related->judul, 50) }}</a>
                                        </h5>
                                        <p class="card-text text-muted">{{ Str::limit(strip_tags($related->berita), 70) }}</p>
                                        <a href="{{ route('pelanggan.berita.detail', $related->id) }}" class="btn btn-sm btn-primary">Baca Selengkapnya</a>
                                    </div>
                ...
                <div class="card shadow-sm border-0 mb-4">
                    <div class="card-body">
                        ...
                        <div class="block-21 mb-4 d-flex">
                            <a href="{{ route('pelanggan.berita.detail', $recent->id) }}" class="blog-img mr-4" style="background-image: url('{{ asset('storage/' . $recent->foto) }}'); min-width: 80px; height: 80px;"></a>
                            <div class="text">
                                <h3 class="heading"><a href="{{ route('pelanggan.berita.detail', $recent->id) }}">{{ Str::limit($recent->judul, 40) }}</a></h3>
                                <div class="meta">
                ...
                <div class="card shadow-sm border-0 mb-4">
                    <div class="card-body">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li class="mb-2">
                                <a href="{{ url('/pelanggan/berita?kategori_id=' . $kategori->id) }}" class="d-flex justify-content-between align-items-center">
